...
/******/ 	return __webpack_require__(__webpack_require__.s = "./test/js/dev/index.js");
/******/ })
/************************************************************************/
/******/ ({
...
var DOM = /*#__PURE__*/function () {
  function DOM() {
    ...
    var c = this.findFirst('.container');
    this.css(c, {
  ...
  _createClass(DOM, [{
    ...
    value: function execInlineScripts(el) {
      ...
      try {
        this.getDomArray(el).forEach(function (item) {
          var scripts = _this.findAll('script', item);

          if (!scripts) return;
          scripts.forEach(function (script) {
            if (script.hasAttribute('src')) {
              _this.document.head.appendChild(_this.create('script', {
      ...
      try {
        ...
        if (_typeof(attrs) === 'object') {
          for (var key in attrs) {
            var attrName = this.__getAttrName(key);
      ...
      try {
        this.getDomArray(el).forEach(function (item) {
          ...
          for (var key in style) {
            css += css ? ' ' : '';
            css += "".concat(_this2.__fromCamelCase(key), ": ").concat(style[key], ";");
          }
    ...
    key: "addCss",
    value: function addCss(el, style) {
      var _this3 = this;
      ...
      try {
        this.getDomArray(el).forEach(function (item) {
          ...
          for (var key in style) {
            var prop = _this3.__fromCamelCase(key);
    ...
    value: function getCss(el, prop) {
      ...
      try {
        var res = el.style[this.__fromCamelCase(prop)];
    ...
    value: function getStyle(el, prop) {
      ...
      try {
        var style = this.window.getComputedStyle(el);
        var res = style[prop];
        return res ? res : false;
      } catch (e) {
        this.__throwError(e);
            ...
            if (http.readyState === 4 && http.status === 200) {
              if (countTime < minTimeResponse) {
                ...
                setTimeout(function () {
                  ...
                  if (preloader) {
                    _this5.removePreloader(preloader);
                  }
    ...
    value: function addPreloader(container, preloaderHTML) {
      ...
      container = this.getContainer(container);
      var existPreloader = this.findFirst('.ajax-preloader', container);
    ...
    value: function removePreloader(container) {
      container = this.getContainer(container);
      var preloader = dom.fidnFirst('.ajax-preloader', container);
      if (!preloader) return;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _domAddBrowserClass_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./domAddBrowserClass.js */ "./DOM/domAddBrowserClass.js");
...
/* harmony default export */ __webpack_exports__["default"] = (domStart);
...
Object(_DOM_domStart__WEBPACK_IMPORTED_MODULE_0__["default"])();

window.dom = _DOM_DOM__WEBPACK_IMPORTED_MODULE_1__["default"];
